...
2.  Stratify census-tract sample
...
- Findings may not generalise automatically to other cities
    - Barcelona is likely a relatively favourable case
    - Validation remains important in other contexts
- Reproducible framework to measure, evaluate, and calibrate OSM-based change
