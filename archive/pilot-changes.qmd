...
```{r}
#| label: 16-validation-stratified
#| echo: false
#| message: false
#| warning: false
#| eval: true
...
```{r}
#| label: 18-validation-map-points
#| echo: false
#| message: false
#| warning: false
...
knitr::kable(
  ...
  caption = "Validation points by class and stratum",
  align = c("l","r","r","r","r"),
  digits = 0
)
```
