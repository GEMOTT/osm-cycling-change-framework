...
The supplementary materials are provided as separate files in the
repository under \texttt{paper/supplements/} and are included with the
peer-review submission. The HTML maps (S2) are intended to be opened
...
\href{../supplements/S1_raw_validation_workbook.xlsx}{S1\_raw\_validation\_workbook.xlsx}
...
\href{../supplements/S2_infra_change_map.html}{S2\_infra\_change\_map.html}\\
\href{../supplements/S2_validation_points_map.html}{S2\_validation\_points\_map.html}
...
\href{../supplements/S3_GSV_validation_protocol.pdf}{S3\_GSV\_validation\_protocol.pdf}
...
\href{../supplements/S4_adjudicated_validation_results.xlsx}{S4\_adjudicated\_validation\_results.xlsx}
