...
knitr::kable(
  ...
  kableExtra::footnote(
    general = "Totals may differ slightly from the aggregate city-level estimates because change segments are split at census-tract boundaries before aggregation.",
    general_title = "Note:",
