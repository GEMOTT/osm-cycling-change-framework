...
scalable alternative when consistent historical official datasets are
unavailable (Bres et al. 2023; Winters et al. 2025). At the same time,
these studies highlight that observed changes can reflect both
