# ================================================================
# utils_core.R
# Shared geometry + caching helpers used across scripts.
#
# Inputs:  sf objects
# Outputs: helper functions (.cache, .get_chr, normalize_lines_safe, len_ok, len_km)
# ================================================================

# Reuse a cached object if up to date, otherwise rebuild and save it
