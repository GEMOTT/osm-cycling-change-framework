...
-   **Precision = TP / (TP + FP)**\
    Percentage of OSM changes that were correct. 
    (How many OSM-detected changes are real)

-   **Recall = TP / (TP + FN)**\
    Percentage of real changes detected by OS.
    (How many real changes OSM detected)
...
- 105 sampled points across 9 strata 
(48 ADD · 8 REMOVE · 49 NONCI)

- 97 usable validation points (both periods coded)  
(44 ADD · 7 REMOVE · 46 NONCI)
...
FILE <- "outputs/barcelona_samples_2015_2023_filled_evt_20251103.xlsx"
...
#### [S2: Validation workbook (Excel)](outputs/barcelona_samples_2015_2023_20251103-1901.xlsx)
