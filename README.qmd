...
Total km of cycle infrastructure added and removed between 2019–2023.

Distribution across census tracts (map + summary stats).

Example: “OSM data suggest 145 km were added and 12 km removed city-wide.”

### Validation results

- Sample drawn: 44 points (ADD 16, REMOVE 6, GENERAL 22), stratified by density × centrality.

- Usable for metrics: 39 points (ADD 15, REMOVE 5, GENERAL 19) — verifiable in both periods.
...
t_final %>%
  kable(
    ...
    caption  = "Validation performance (usable points only)"
  ) %>%
  kable_styling(
    full_width = FALSE,
    position   = "center",
