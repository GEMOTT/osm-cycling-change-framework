...
leaflet(options = leafletOptions(zoomControl = TRUE)) %>%
  ...
  # optional: always-visible year labels per layer
  addLabelOnlyMarkers(
  ...
  hideGroup("Streets") %>%
  hideGroup("General points") %>%
  hideGroup("Cycleway points") %>%
  hideGroup("Year labels (general)") %>%
  hideGroup("Year labels (cycleway)")
```
